...
#   indices*: uint16 # Vertex indices (in case vertex data comes indexed) (6 indices per quad)
...
proc rlglDraw*() {.RLAPI, importc: "rlglDraw"}
proc rlLoadExtensions*(loader: void) {.RLAPI, importc: "rlLoadExtensions".} # Load OpenGL extensions (loader function pointer required)
...
proc rlGetShapesTexture*(): Texture2D {.RLAPI, importc: "rlGetShapesTexture".} # Get texture to draw shapes
proc rlGetShapesTextureRec*(): Rectangle {.RLAPI, importc: "rlGetShapesTextureRec".} # Get texture rectangle to draw shapes
proc rlSetShapesTexture*(texture: Texture2D; source: Rectangle) {.RLAPI, importc: "rlSetShapesTexture".} # Define default texture used to draw shapes
...
proc rlGenTextureCubemap*(shader: Shader; panorama: Texture2D; size: int32; format: int32): TextureCubemap {.RLAPI, importc: "rlGenTextureCubemap".} # Generate cubemap (6 faces) from equirectangular (panorama) texture
proc rlGenTextureIrradiance*(shader: Shader; cubemap: TextureCubemap; size: int32): TextureCubemap {.RLAPI, importc: "rlGenTextureIrradiance".} # Generate irradiance cubemap using cubemap texture
proc rlGenTexturePrefilter*(shader: Shader; cubemap: TextureCubemap; size: int32): TextureCubemap {.RLAPI, importc: "rlGenTexturePrefilter".} # Generate prefilter cubemap using cubemap texture
proc rlGenTextureBRDF*(shader: Shader; size: int32): Texture2D {.RLAPI, importc: "rlGenTextureBRDF".} # Generate a generic BRDF texture
# 
#   RLGL IMPLEMENTATION
# 
# ----------------------------------------------------------------------------------
